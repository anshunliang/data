...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        self.t99.setGeometry(150, 150, 820, 60)  #位置，大小
        self.t99.setText("select user_id from ad where user_id>30;")
    ...
    def dq(self):
        ...
        reply = QMessageBox.question(self, '提示', '数据已保存在本地文件夹', QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
